...
/**
 * @file
 * Template for the Simmons 3Col Footer layout.
 *
 * Variables:
 ...
 */
?>
<div class="layout--simmons-3col-footer <?php print implode(' ', $classes); ?>"<?php print backdrop_attributes($attributes); ?>>
  <div id="skip-link">
  ...
  <?php endif; ?>
</div><!-- /.layout--simmons-3col-footer -->
