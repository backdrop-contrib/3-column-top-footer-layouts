...
/**
 * @file
 * Template for the Moscone 3col Footer layout.
 *
 * Variables:
 ...
 */
?>
<div class="layout--moscone-3col-footer <?php print implode(' ', $classes); ?>"<?php print backdrop_attributes($attributes); ?>>
  <div id="skip-link">
  ...
  <?php endif; ?>
</div><!-- /.layout--moscone-3col-footer -->
