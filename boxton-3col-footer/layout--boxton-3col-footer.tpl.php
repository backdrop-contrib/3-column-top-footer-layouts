...
/**
 * @file
 * Template for the Boxton 3col Footer layout.
 *
 * Variables:
 ...
 */
?>
<div class="layout--boxton-3col-footer <?php print implode(' ', $classes); ?>"<?php print backdrop_attributes($attributes); ?>>
  <div id="skip-link">
