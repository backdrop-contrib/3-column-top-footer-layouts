...
/**
 * @file
 * Template for the Taylor 3Col Footer layout.
 *
 * Variables:
 ...
 */
?>
<div class="layout--taylor-3col-footer <?php print implode(' ', $classes); ?>"<?php print backdrop_attributes($attributes); ?>>
  <div id="skip-link">
