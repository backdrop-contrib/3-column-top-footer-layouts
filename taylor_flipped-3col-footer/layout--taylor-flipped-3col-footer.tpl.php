...
/**
 * @file
 * Template for the Taylor Flipped 3Col Footer layout.
 *
 * Variables:
 ...
 */
?>
<div class="layout--taylor-flipped-3col-footer <?php print implode(' ', $classes); ?>"<?php print backdrop_attributes($attributes); ?>>
  <div id="skip-link">
  ...
  <?php endif; ?>
</div><!-- /.layout--taylor-flipped-3col-footer -->
